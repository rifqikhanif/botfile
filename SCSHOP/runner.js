...
number = '6288227606701@s.whatsapp.net'
...
zero.browserDescription = [ 'rifqikhanif', 'Firefox', '3.0' ]
console.log(banner.string)
console.log(color('[•] [ dibuat oleh rifqikhanif ] [•]'))
console.log(color('all team'))
console.log(color(' ==============================================='))
console.log(color('│ ○ rifqikhanif                     '))
console.log(color('│ ○ riska chan                 '))
console.log(color('│ ○ jonathan                        '))
console.log(color('│ ○ rival                       '))
console.log(color(' ==============================================='))
zero.on('qr', () => {
...
sendButImage(anu.jid, teks, `©babyBot`, img,but = [{buttonId:`hallo`, 
...
sendButImage(anu.jid, teks, `©BabyBot`, img,but= [{buttonId: `byebye`, buttonText: {displayText: `SELAMAT TINGGAL!!!`}, type: 1}], options = {contextInfo: {mentionedJid: [num, number]}, thumbnail: Buffer.alloc(0)})
}
